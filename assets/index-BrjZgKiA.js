(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();class el extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.innerHTML=`
      <style>
        :host {
          --corner-radius: 24px;
          --base-strength: 14px;
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:qn,depthTest:!1,depthWrite:!1})}function vc(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ul(),fragmentShader:`
		...
		`,blending:qn,depthTest:!1,depthWrite:!1})}function xc(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ul(),fragmentShader:`
	...
	`}function c_(s){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===ao||l===oo,h=l===vs||l===xs;if(c||h){let u=e.get(o);const d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new _c(s)),u=c?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{const p=o.image;return c&&p&&p.height>0||h&&p&&i(p)?(t===null&&(t=new _c(s)),u=c?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function i(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function h_(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&ds("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function u_(s,e,t,n){const i={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",a),delete i[d.id];const p=r.get(d);p&&(e.remove(p),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return i[d.id]===!0||(d.addEventListener("dispose",a),i[d.id]=!0,t.memory.geometries++),d}function l(u){const d=u.attributes;for(const p in d)e.update(d[p],s.ARRAY_BUFFER)}function c(u){const d=[],p=u.index,g=u.attributes.position;let _=0;if(p!==null){const A=p.array;_=p.version;for(let w=0,v=A.length;w<v;w+=3){const y=A[w+0],E=A[w+1],b=A[w+2];d.push(y,E,E,b,b,y)}}else if(g!==void 0){const A=g.array;_=g.version;for(let w=0,v=A.length/3-1;w<v;w+=3){const y=w+0,E=w+1,b=w+2;d.push(y,E,E,b,b,y)}}else return;const m=new(Mh(d)?Ah:wh)(d,1);m.version=_;const f=r.get(u);f&&e.remove(f),r.set(u,m)}function h(u){const d=r.get(u);if(d){const p=u.index;p!==null&&d.version<p.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function d_(s,e,t){let n;function i(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function l(d,p){s.drawElements(n,p,r,d*a),t.update(p,n,1)}function c(d,p,g){g!==0&&(s.drawElementsInstanced(n,p,r,d*a,g),t.update(p,n,g))}function h(d,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,d,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,n,1)}function u(d,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)c(d[f]/a,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,d,0,_,0,g);let f=0;for(let A=0;A<g;A++)f+=p[A]*_[A];t.update(f,n,1)}}this.setMode=i,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function f_(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case s.TRIANGLES:t.triangles+=o*(r/3);break;case s.LINES:t.lines+=o*(r/2);break;case s.LINE_STRIP:t.lines+=o*(r-1);break;case s.LINE_LOOP:t.lines+=o*r;break;case s.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function p_(s,e,t){const n=new WeakMap,i=new at;function r(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let M=function(){R.dispose(),n.delete(o),o.removeEventListener("dispose",M)};var p=M;d!==void 0&&d.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],A=o.morphAttributes.normal||[],w=o.morphAttributes.color||[];let v=0;g===!0&&(v=1),_===!0&&(v=2),m===!0&&(v=3);let y=o.attributes.position.count*v,E=1;y>e.maxTextureSize&&(E=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);const b=new Float32Array(y*E*4*u),R=new Sh(b,y,E,u);R.type=Wn,R.needsUpdate=!0;const x=v*4;for(let L=0;L<u;L++){const z=f[L],O=A[L],V=w[L],q=y*E*4*L;for(let H=0;H<z.count;H++){const Y=H*x;g===!0&&(i.fromBufferAttribute(z,H),b[q+Y+0]=i.x,b[q+Y+1]=i.y,b[q+Y+2]=i.z,b[q+Y+3]=0),_===!0&&(i.fromBufferAttribute(O,H),b[q+Y+4]=i.x,b[q+Y+5]=i.y,b[q+Y+6]=i.z,b[q+Y+7]=0),m===!0&&(i.fromBufferAttribute(V,H),b[q+Y+8]=i.x,b[q+Y+9]=i.y,b[q+Y+10]=i.z,b[q+Y+11]=V.itemSize===4?i.w:1)}}d={count:u,texture:R,size:new Ce(y,E)},n.set(o,d),o.addEventListener("dispose",M)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(s,"morphTexture",a.morphTexture,t);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const _=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(s,"morphTargetBaseInfluence",_),l.getUniforms().setValue(s,"morphTargetInfluences",c)}l.getUniforms().setValue(s,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(s,"morphTargetsTextureSize",d.size)}return{update:r}}function m_(s,e,t,n){let i=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,u=e.get(l,h);if(i.get(u)!==c&&(e.update(u),i.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(t.update(l.instanceMatrix,s.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,s.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return u}function a(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}const Oh=new kt,Mc=new Uh(1,1),Fh=new Sh,zh=new Gd,Bh=new Dh,Sc=[],yc=[],Ec=new Float32Array(16),Tc=new Float32Array(9),bc=new Float32Array(4);function Rs(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=Sc[i];if(r===void 0&&(r=new Float32Array(i),Sc[i]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,s[a].toArray(r,o)}return r}function yt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function Et(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function ia(s,e){let t=yc[e];t===void 0&&(t=new Int32Array(e),yc[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function __(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function g_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;s.uniform2fv(this.addr,e),Et(t,e)}}function v_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(yt(t,e))return;s.uniform3fv(this.addr,e),Et(t,e)}}function x_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;s.uniform4fv(this.addr,e),Et(t,e)}}function M_(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,n))return;bc.set(n),s.uniformMatrix2fv(this.addr,!1,bc),Et(t,n)}}function S_(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,n))return;Tc.set(n),s.uniformMatrix3fv(this.addr,!1,Tc),Et(t,n)}}function y_(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,n))return;Ec.set(n),s.uniformMatrix4fv(this.addr,!1,Ec),Et(t,n)}}function E_(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function T_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;s.uniform2iv(this.addr,e),Et(t,e)}}function b_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;s.uniform3iv(this.addr,e),Et(t,e)}}function w_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;s.uniform4iv(this.addr,e),Et(t,e)}}function A_(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function C_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;s.uniform2uiv(this.addr,e),Et(t,e)}}function R_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;s.uniform3uiv(this.addr,e),Et(t,e)}}function P_(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;s.uniform4uiv(this.addr,e),Et(t,e)}}function L_(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Mc.compareFunction=xh,r=Mc):r=Oh,t.setTexture2D(e||r,i)}function D_(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||zh,i)}function I_(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Bh,i)}function U_(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Fh,i)}function N_(s){switch(s){case 5126:return __;case 35664:return g_;case 35665:return v_;case 35666:return x_;case 35674:return M_;case 35675:return S_;case 35676:return y_;case 5124:case 35670:return E_;case 35667:case 35671:return T_;case 35668:case 35672:return b_;case 35669:case 35673:return w_;case 5125:return A_;case 36294:return C_;case 36295:return R_;case 36296:return P_;case 35678:case 36198:case 36298:case 36306:case 35682:return L_;case 35679:case 36299:case 36307:return D_;case 35680:case 36300:case 36308:case 36293:return I_;case 36289:case 36303:case 36311:case 36292:return U_}}function O_(s,e){s.uniform1fv(this.addr,e)}function F_(s,e){const t=Rs(e,this.size,2);s.uniform2fv(this.addr,t)}function z_(s,e){const t=Rs(e,this.size,3);s.uniform3fv(this.addr,t)}function B_(s,e){const t=Rs(e,this.size,4);s.uniform4fv(this.addr,t)}function k_(s,e){const t=Rs(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function G_(s,e){const t=Rs(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function H_(s,e){const t=Rs(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function V_(s,e){s.uniform1iv(this.addr,e)}function W_(s,e){s.uniform2iv(this.addr,e)}function X_(s,e){s.uniform3iv(this.addr,e)}function q_(s,e){s.uniform4iv(this.addr,e)}function Y_(s,e){s.uniform1uiv(this.addr,e)}function j_(s,e){s.uniform2uiv(this.addr,e)}function K_(s,e){s.uniform3uiv(this.addr,e)}function Z_(s,e){s.uniform4uiv(this.addr,e)}function $_(s,e,t){const n=this.cache,i=e.length,r=ia(t,i);yt(n,r)||(s.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==i;++a)t.setTexture2D(e[a]||Oh,r[a])}function J_(s,e,t){const n=this.cache,i=e.length,r=ia(t,i);yt(n,r)||(s.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||zh,r[a])}function Q_(s,e,t){const n=this.cache,i=e.length,r=ia(t,i);yt(n,r)||(s.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||Bh,r[a])}function eg(s,e,t){const n=this.cache,i=e.length,r=ia(t,i);yt(n,r)||(s.uniform1iv(this.addr,r),Et(n,r));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||Fh,r[a])}function tg(s){switch(s){case 5126:return O_;case 35664:return F_;case 35665:return z_;case 35666:return B_;case 35674:return k_;case 35675:return G_;case 35676:return H_;case 5124:case 35670:return V_;case 35667:case 35671:return W_;case 35668:case 35672:return X_;case 35669:case 35673:return q_;case 5125:return Y_;case 36294:return j_;case 36295:return K_;case 36296:return Z_;case 35678:case 36198:case 36298:case 36306:case 35682:return $_;case 35679:case 36299:case 36307:return J_;case 35680:case 36300:case 36308:case 36293:return Q_;case 36289:case 36303:case 36311:case 36292:return eg}}class ng{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=N_(t.type)}}class ig{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=tg(t.type)}}class sg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,a=i.length;r!==a;++r){const o=i[r];o.setValue(e,t[o.id],n)}}}const Ga=/(\w+)(\])?(\[|\.)?/g;function wc(s,e){s.seq.push(e),s.map[e.id]=e}function rg(s,e,t){const n=s.name,i=n.length;for(Ga.lastIndex=0;;){const r=Ga.exec(n),a=Ga.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){wc(t,c===void 0?new ng(o,s,e):new ig(o,s,e));break}else{let u=t.map[o];u===void 0&&(u=new sg(o),wc(t,u)),t=u}}}class Hr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),a=e.getUniformLocation(t,r.name);rg(r,a,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const a=e[i];a.id in t&&n.push(a)}return n}}function Ac(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const ag=37297;let og=0;function lg(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=i;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Cc=new Ue;function cg(s){He._getMatrix(Cc,He.workingColorSpace,s);const e=`mat3( ${Cc.elements.map(t=>t.toFixed(4))} )`;switch(He.getTransfer(s)){case qr:return[e,"LinearTransferOETF"];case Ze:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function Rc(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),i=s.getShaderInfoLog(e).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`
...
`)}function ug(s,e){let t;switch(e){case fd:t="Linear";break;case pd:t="Reinhard";break;case lh:t="Cineon";break;case md:t="ACESFilmic";break;case gd:t="AgX";break;case vd:t="Neutral";break;case _d:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Dr=new C;function dg(){He.getLuminanceCoefficients(Dr);const s=Dr.x.toFixed(4),e=Dr.y.toFixed(4),t=Dr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function fg(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(zs).join(`
`)}function pg(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function mg(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function zs(s){return s!==""}function Pc(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Lc(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const _g=/^[ \t]*#include +<([\w\d./]+)>/gm;function zo(s){return s.replace(_g,vg)}const gg=new Map;function vg(s,e){let t=Oe[e];if(t===void 0){const n=gg.get(e);if(n!==void 0)t=Oe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return zo(t)}const xg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Dc(s){return s.replace(xg,Mg)}function Mg(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Ic(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function Sg(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===rh?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===ah?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Gn&&(e="SHADOWMAP_TYPE_VSM"),e}function yg(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case vs:case xs:e="ENVMAP_TYPE_CUBE";break;case na:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Eg(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case xs:e="ENVMAP_MODE_REFRACTION";break}return e}function Tg(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case oh:e="ENVMAP_BLENDING_MULTIPLY";break;case ud:e="ENVMAP_BLENDING_MIX";break;case dd:e="ENVMAP_BLENDING_ADD";break}return e}function bg(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function wg(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Sg(t),c=yg(t),h=Eg(t),u=Tg(t),d=bg(t),p=fg(t),g=pg(r),_=i.createProgram();let m,f,A=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);const w=A+m+a,v=A+f+o,y=Ac(i,i.VERTEX_SHADER,w),E=Ac(i,i.FRAGMENT_SHADER,v);i.attachShader(_,y),i.attachShader(_,E),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(L){if(s.debug.checkShaderErrors){const z=i.getProgramInfoLog(_).trim(),O=i.getShaderInfoLog(y).trim(),V=i.getShaderInfoLog(E).trim();let q=!0,H=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(q=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,y,E);else{const Y=Rc(i,y,"vertex"),G=Rc(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
*/var on={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},ys={duration:.5,overwrite:!1,delay:0},pl,wt,rt,_n=1e8,et=1/_n,Bo=Math.PI*2,C0=Bo/4,R0=0,Hh=Math.sqrt,P0=Math.cos,L0=Math.sin,bt=function(e){return typeof e=="string"},mt=function(e){return typeof e=="function"},jn=function(e){return typeof e=="number"},ml=function(e){return typeof e>"u"},Un=function(e){return typeof e=="object"},Gt=function(e){return e!==!1},_l=function(){return typeof window<"u"},Nr=function(e){return mt(e)||bt(e)},Vh=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Lt=Array.isArray,D0=/random\([^)]+\)/g,I0=/,\s*/g,kc=/(?:-?\.?\d|\.)+/gi,Wh=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,ls=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Va=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Xh=/[+-]=-?[.\d]+/,U0=/[^,'"\[\]\s]+/gi,N0=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,ut,An,ko,gl,ln={},Kr={},qh,Yh=function(e){return(Kr=Es(e,ln))&&qt},vl=function(e,t){return console.warn("Invalid property",e,"set to",t,"Missing plugin? gsap.registerPlugin()")},Ks=function(e,t){return!t&&console.warn(e)},jh=function(e,t){return e&&(ln[e]=t)&&Kr&&(Kr[e]=t)||ln},Zs=function(){return 0},O0={suppressEvents:!0,isStart:!0,kill:!1},Vr={suppressEvents:!0,kill:!1},F0={suppressEvents:!0},xl={},ui=[],Go={},Kh,Jt={},Wa={},Gc=30,Wr=[],Ml="",Sl=function(e){var t=e[0],n,i;if(Un(t)||mt(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(i=Wr.length;i--&&!Wr[i].targetTest(t););n=Wr[i]}for(i=e.length;i--;)e[i]&&(e[i]._gsap||(e[i]._gsap=new xu(e[i],n)))||e.splice(i,1);return e},Fi=function(e){return e._gsap||Sl(gn(e))[0]._gsap},Zh=function(e,t,n){return(n=e[t])&&mt(n)?e[t]():ml(n)&&e.getAttribute&&e.getAttribute(t)||n},Ht=function(e,t){return(e=e.split(",")).forEach(t)||e},gt=function(e){return Math.round(e*1e5)/1e5||0},ht=function(e){return Math.round(e*1e7)/1e7||0},ps=function(e,t){var n=t.charAt(0),i=parseFloat(t.substr(2));return e=parseFloat(e),n==="+"?e+i:n==="-"?e-i:n==="*"?e*i:e/i},z0=function(e,t){for(var n=t.length,i=0;e.indexOf(t[i])<0&&++i<n;);return i<n},Zr=function(){var e=ui.length,t=ui.slice(0),n,i;for(Go={},ui.length=0,n=0;n<e;n++)i=t[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},yl=function(e){return!!(e._initted||e._startAt||e.add)},$h=function(e,t,n,i){ui.length&&!wt&&Zr(),e.render(t,n,!!(wt&&t<0&&yl(e))),ui.length&&!wt&&Zr()},Jh=function(e){var t=parseFloat(e);return(t||t===0)&&(e+"").match(U0).length<2?t:bt(e)?e.trim():e},Qh=function(e){return e},cn=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},B0=function(e){return function(t,n){for(var i in n)i in t||i==="duration"&&e||i==="ease"||(t[i]=n[i])}},Es=function(e,t){for(var n in t)e[n]=t[n];return e},Hc=function s(e,t){for(var n in t)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(e[n]=Un(t[n])?s(e[n]||(e[n]={}),t[n]):t[n]);return e},$r=function(e,t){var n={},i;for(i in e)i in t||(n[i]=e[i]);return n},Hs=function(e){var t=e.parent||ut,n=e.keyframes?B0(Lt(e.keyframes)):cn;if(Gt(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},k0=function(e,t){for(var n=e.length,i=n===t.length;i&&n--&&e[n]===t[n];);return n<0},eu=function(e,t,n,i,r){var a=e[i],o;if(r)for(o=t[r];a&&a[r]>o;)a=a._prev;return a?(t._next=a._next,a._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[i]=t,t._prev=a,t.parent=t._dp=e,t},ra=function(e,t,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var r=t._prev,a=t._next;r?r._next=a:e[n]===t&&(e[n]=a),a?a._prev=r:e[i]===t&&(e[i]=r),t._next=t._prev=t.parent=null},gi=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},zi=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},G0=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},Ho=function(e,t,n,i){return e._startAt&&(wt?e._startAt.revert(Vr):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,i))},H0=function s(e){return!e||e._ts&&s(e.parent)},Vc=function(e){return e._repeat?Ts(e._tTime,e=e.duration()+e._rDelay)*e:0},Ts=function(e,t){var n=Math.floor(e=ht(e/t));return e&&n===e?n-1:n},Jr=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},aa=function(e){return e._end=ht(e._start+(e._tDur/Math.abs(e._ts||e._rts||et)||0))},oa=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=ht(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),aa(e),n._dirty||zi(n,e)),e},tu=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=Jr(e.rawTime(),t),(!t._dur||lr(0,t.totalDuration(),n)-t._tTime>et)&&t.render(n,!0)),zi(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-et}},Rn=function(e,t,n,i){return t.parent&&gi(t),t._start=ht((jn(n)?n:n||e!==ut?fn(e,n,t):e._time)+t._delay),t._end=ht(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),eu(e,t,"_first","_last",e._sort?"_start":0),Vo(t)||(e._recent=t),i||tu(e,t),e._ts<0&&oa(e,e._tTime),e},nu=function(e,t){return(ln.ScrollTrigger||vl("scrollTrigger",t))&&ln.ScrollTrigger.create(t,e)},iu=function(e,t,n,i,r){if(Tl(e,t,r),!e._initted)return 1;if(!n&&e._pt&&!wt&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&Kh!==tn.frame)return ui.push(e),e._lazy=[r,i],1},V0=function s(e){var t=e.parent;return t&&t._ts&&t._initted&&!t._lock&&(t.rawTime()<0||s(t))},Vo=function(e){var t=e.data;return t==="isFromStart"||t==="isStart"},W0=function(e,t,n,i){var r=e.ratio,a=t<0||!t&&(!e._start&&V0(e)&&!(!e._initted&&Vo(e))||(e._ts<0||e._dp._ts<0)&&!Vo(e))?0:1,o=e._rDelay,l=0,c,h,u;if(o&&e._repeat&&(l=lr(0,e._tDur,t),h=Ts(l,o),e._yoyo&&h&1&&(a=1-a),h!==Ts(e._tTime,o)&&(r=1-a,e.vars.repeatRefresh&&e._initted&&e.invalidate())),a!==r||wt||i||e._zTime===et||!t&&e._zTime){if(!e._initted&&iu(e,t,i,n,l))return;for(u=e._zTime,e._zTime=t||(n?et:0),n||(n=t&&!u),e.ratio=a,e._from&&(a=1-a),e._time=0,e._tTime=l,c=e._pt;c;)c.r(a,c.d),c=c._next;t<0&&Ho(e,t,n,!0),e._onUpdate&&!n&&sn(e,"onUpdate"),l&&e._repeat&&!n&&e.parent&&sn(e,"onRepeat"),(t>=e._tDur||t<0)&&e.ratio===a&&(a&&gi(e,1),!n&&!wt&&(sn(e,a?"onComplete":"onReverseComplete",!0),e._prom&&e._prom()))}else e._zTime||(e._zTime=t)},X0=function(e,t,n){var i;if(n>t)for(i=e._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>t)return i;i=i._next}else for(i=e._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<t)return i;i=i._prev}},bs=function(e,t,n,i){var r=e._repeat,a=ht(t)||0,o=e._tTime/e._tDur;return o&&!i&&(e._time*=a/e._dur),e._dur=a,e._tDur=r?r<0?1e10:ht(a*(r+1)+e._rDelay*r):a,o>0&&!i&&oa(e,e._tTime=e._tDur*o),e.parent&&aa(e),n||zi(e.parent,e),e},Wc=function(e){return e instanceof Nt?zi(e):bs(e,e._dur)},q0={_start:0,endTime:Zs,totalDuration:Zs},fn=function s(e,t,n){var i=e.labels,r=e._recent||q0,a=e.duration()>=_n?r.endTime(!1):e._dur,o,l,c;return bt(t)&&(isNaN(t)||t in i)?(l=t.charAt(0),c=t.substr(-1)==="%",o=t.indexOf("="),l==="<"||l===">"?(o>=0&&(t=t.replace(/=/,"")),(l==="<"?r._start:r.endTime(r._repeat>=0))+(parseFloat(t.substr(1))||0)*(c?(o<0?r:n).totalDuration()/100:1)):o<0?(t in i||(i[t]=a),i[t]):(l=parseFloat(t.charAt(o-1)+t.substr(o+1)),c&&n&&(l=l/100*(Lt(n)?n[0]:n).totalDuration()),o>1?s(e,t.substr(0,o-1),n)+l:a+l)):t==null?a:+t},Vs=function(e,t,n){var i=jn(t[1]),r=(i?2:1)+(e<2?0:1),a=t[r],o,l;if(i&&(a.duration=t[1]),a.parent=n,e){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=Gt(l.vars.inherit)&&l.parent;a.immediateRender=Gt(o.immediateRender),e<2?a.runBackwards=1:a.startAt=t[r-1]}return new xt(t[0],a,t[r+1])},Mi=function(e,t){return e||e===0?t(e):t},lr=function(e,t,n){return n<e?e:n>t?t:n},Rt=function(e,t){return!bt(e)||!(t=N0.exec(e))?"":t[1]},Y0=function(e,t,n){return Mi(n,function(i){return lr(e,t,i)})},Wo=[].slice,su=function(e,t){return e&&Un(e)&&"length"in e&&(!t&&!e.length||e.length-1 in e&&Un(e[0]))&&!e.nodeType&&e!==An},j0=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(i){var r;return bt(i)&&!t||su(i,1)?(r=n).push.apply(r,gn(i)):n.push(i)})||n},gn=function(e,t,n){return rt&&!t&&rt.selector?rt.selector(e):bt(e)&&!n&&(ko||!ws())?Wo.call((t||gl).querySelectorAll(e),0):Lt(e)?j0(e,n):su(e)?Wo.call(e,0):e?[e]:[]},Xo=function(e){return e=gn(e)[0]||Ks("Invalid scope")||{},function(t){var n=e.current||e.nativeElement||e;return gn(t,n.querySelectorAll?n:n===e?Ks("Invalid scope")||gl.createElement("div"):e)}},ru=function(e){return e.sort(function(){return .5-Math.random()})},au=function(e){if(mt(e))return e;var t=Un(e)?e:{each:e},n=Bi(t.ease),i=t.from||0,r=parseFloat(t.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,c=t.axis,h=i,u=i;return bt(i)?h=u={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(h=i[0],u=i[1]),function(d,p,g){var _=(g||t).length,m=a[_],f,A,w,v,y,E,b,R,x;if(!m){if(x=t.grid==="auto"?0:(t.grid||[1,_n])[1],!x){for(b=-_n;b<(b=g[x++].getBoundingClientRect().left)&&x<_;);x<_&&x--}for(m=a[_]=[],f=l?Math.min(x,_)*h-.5:i%x,A=x===_n?0:l?_*u/x-.5:i/x|0,b=0,R=_n,E=0;E<_;E++)w=E%x-f,v=A-(E/x|0),m[E]=y=c?Math.abs(c==="y"?v:w):Hh(w*w+v*v),y>b&&(b=y),y<R&&(R=y);i==="random"&&ru(m),m.max=b-R,m.min=R,m.v=_=(parseFloat(t.amount)||parseFloat(t.each)*(x>_?_-1:c?c==="y"?_/x:x:Math.max(x,_/x))||0)*(i==="edges"?-1:1),m.b=_<0?r-_:r,m.u=Rt(t.amount||t.each)||0,n=n&&_<0?_u(n):n}return _=(m[d]-m.min)/m.max||0,ht(m.b+(n?n(_):_)*m.v)+m.u}},qo=function(e){var t=Math.pow(10,((e+"").split(".")[1]||"").length);return function(n){var i=ht(Math.round(parseFloat(n)/e)*e*t);return(i-i%1)/t+(jn(n)?0:Rt(n))}},ou=function(e,t){var n=Lt(e),i,r;return!n&&Un(e)&&(i=n=e.radius||_n,e.values?(e=gn(e.values),(r=!jn(e[0]))&&(i*=i)):e=qo(e.increment)),Mi(t,n?mt(e)?function(a){return r=e(a),Math.abs(r-a)<=i?r:a}:function(a){for(var o=parseFloat(r?a.x:a),l=parseFloat(r?a.y:0),c=_n,h=0,u=e.length,d,p;u--;)r?(d=e[u].x-o,p=e[u].y-l,d=d*d+p*p):d=Math.abs(e[u]-o),d<c&&(c=d,h=u);return h=!i||c<=i?e[h]:a,r||h===a||jn(a)?h:h+Rt(a)}:qo(e))},lu=function(e,t,n,i){return Mi(Lt(e)?!t:n===!0?!!(n=0):!i,function(){return Lt(e)?e[~~(Math.random()*e.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*i)/i})},K0=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(i){return t.reduce(function(r,a){return a(r)},i)}},Z0=function(e,t){return function(n){return e(parseFloat(n))+(t||Rt(n))}},$0=function(e,t,n){return hu(e,t,0,1,n)},cu=function(e,t,n){return Mi(n,function(i){return e[~~t(i)]})},J0=function s(e,t,n){var i=t-e;return Lt(e)?cu(e,s(0,e.length),t):Mi(n,function(r){return(i+(r-e)%i)%i+e})},Q0=function s(e,t,n){var i=t-e,r=i*2;return Lt(e)?cu(e,s(0,e.length-1),t):Mi(n,function(a){return a=(r+(a-e)%r)%r||0,e+(a>i?r-a:a)})},$s=function(e){return e.replace(D0,function(t){var n=t.indexOf("[")+1,i=t.substring(n||7,n?t.indexOf("]"):t.length-1).split(I0);return lu(n?i:+i[0],n?0:+i[1],+i[2]||1e-5)})},hu=function(e,t,n,i,r){var a=t-e,o=i-n;return Mi(r,function(l){return n+((l-e)/a*o||0)})},ev=function s(e,t,n,i){var r=isNaN(e+t)?0:function(p){return(1-p)*e+p*t};if(!r){var a=bt(e),o={},l,c,h,u,d;if(n===!0&&(i=1)&&(n=null),a)e={p:e},t={p:t};else if(Lt(e)&&!Lt(t)){for(h=[],u=e.length,d=u-2,c=1;c<u;c++)h.push(s(e[c-1],e[c]));u--,r=function(g){g*=u;var _=Math.min(d,~~g);return h[_](g-_)},n=t}else i||(e=Es(Lt(e)?[]:{},e));if(!h){for(l in t)El.call(o,e,l,"get",t[l]);r=function(g){return Al(g,o)||(a?e.p:e)}}}return Mi(n,r)},Xc=function(e,t,n){var i=e.labels,r=_n,a,o,l;for(a in i)o=i[a]-t,o<0==!!n&&o&&r>(o=Math.abs(o))&&(l=a,r=o);return l},sn=function(e,t,n){var i=e.vars,r=i[t],a=rt,o=e._ctx,l,c,h;if(r)return l=i[t+"Params"],c=i.callbackScope||e,n&&ui.length&&Zr(),o&&(rt=o),h=l?r.apply(c,l):r.call(c),rt=a,h},Bs=function(e){return gi(e),e.scrollTrigger&&e.scrollTrigger.kill(!!wt),e.progress()<1&&sn(e,"onInterrupt"),e},cs,uu=[],du=function(e){if(e)if(e=!e.name&&e.default||e,_l()||e.headless){var t=e.name,n=mt(e),i=t&&!n&&e.init?function(){this._props=[]}:e,r={init:Zs,render:Al,add:El,kill:_v,modifier:mv,rawVars:0},a={targetTest:0,get:0,getSetter:wl,aliases:{},register:0};if(ws(),e!==i){if(Jt[t])return;cn(i,cn($r(e,r),a)),Es(i.prototype,Es(r,$r(e,a))),Jt[i.prop=t]=i,e.targetTest&&(Wr.push(i),xl[t]=1),t=(t==="css"?"CSS":t.charAt(0).toUpperCase()+t.substr(1))+"Plugin"}jh(t,i),e.register&&e.register(qt,i,Vt)}else uu.push(e)},Qe=255,ks={aqua:[0,Qe,Qe],lime:[0,Qe,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Qe],navy:[0,0,128],white:[Qe,Qe,Qe],olive:[128,128,0],yellow:[Qe,Qe,0],orange:[Qe,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Qe,0,0],pink:[Qe,192,203],cyan:[0,Qe,Qe],transparent:[Qe,Qe,Qe,0]},Xa=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*Qe+.5|0},fu=function(e,t,n){var i=e?jn(e)?[e>>16,e>>8&Qe,e&Qe]:0:ks.black,r,a,o,l,c,h,u,d,p,g;if(!i){if(e.substr(-1)===","&&(e=e.substr(0,e.length-1)),ks[e])i=ks[e];else if(e.charAt(0)==="#"){if(e.length<6&&(r=e.charAt(1),a=e.charAt(2),o=e.charAt(3),e="#"+r+r+a+a+o+o+(e.length===5?e.charAt(4)+e.charAt(4):"")),e.length===9)return i=parseInt(e.substr(1,6),16),[i>>16,i>>8&Qe,i&Qe,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),i=[e>>16,e>>8&Qe,e&Qe]}else if(e.substr(0,3)==="hsl"){if(i=g=e.match(kc),!t)l=+i[0]%360/360,c=+i[1]/100,h=+i[2]/100,a=h<=.5?h*(c+1):h+c-h*c,r=h*2-a,i.length>3&&(i[3]*=1),i[0]=Xa(l+1/3,r,a),i[1]=Xa(l,r,a),i[2]=Xa(l-1/3,r,a);else if(~e.indexOf("="))return i=e.match(Wh),n&&i.length<4&&(i[3]=1),i}else i=e.match(kc)||ks.transparent;i=i.map(Number)}return t&&!g&&(r=i[0]/Qe,a=i[1]/Qe,o=i[2]/Qe,u=Math.max(r,a,o),d=Math.min(r,a,o),h=(u+d)/2,u===d?l=c=0:(p=u-d,c=h>.5?p/(2-u-d):p/(u+d),l=u===r?(a-o)/p+(a<o?6:0):u===a?(o-r)/p+2:(r-a)/p+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(h*100+.5)),n&&i.length<4&&(i[3]=1),i},pu=function(e){var t=[],n=[],i=-1;return e.split(di).forEach(function(r){var a=r.match(ls)||[];t.push.apply(t,a),n.push(i+=a.length+1)}),t.c=n,t},qc=function(e,t,n){var i="",r=(e+i).match(di),a=t?"hsla(":"rgba(",o=0,l,c,h,u;if(!r)return e;if(r=r.map(function(d){return(d=fu(d,t,1))&&a+(t?d[0]+","+d[1]+"%,"+d[2]+"%,"+d[3]:d.join(","))+")"}),n&&(h=pu(e),l=n.c,l.join(i)!==h.c.join(i)))for(c=e.replace(di,"1").split(ls),u=c.length-1;o<u;o++)i+=c[o]+(~l.indexOf(o)?r.shift()||a+"0,0,0,0)":(h.length?h:r.length?r:n).shift());if(!c)for(c=e.split(di),u=c.length-1;o<u;o++)i+=c[o]+r[o];return i+c[u]},di=function(){var s="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",e;for(e in ks)s+="|"+e+"\\b";return new RegExp(s+")","gi")}(),tv=/hsl[a]?\(/,mu=function(e){var t=e.join(" "),n;if(di.lastIndex=0,di.test(t))return n=tv.test(t),e[1]=qc(e[1],n),e[0]=qc(e[0],n,pu(e[1])),!0},Js,tn=function(){var s=Date.now,e=500,t=33,n=s(),i=n,r=1e3/240,a=r,o=[],l,c,h,u,d,p,g=function _(m){var f=s()-i,A=m===!0,w,v,y,E;if((f>e||f<0)&&(n+=f-t),i+=f,y=i-n,w=y-a,(w>0||A)&&(E=++u.frame,d=y-u.time*1e3,u.time=y=y/1e3,a+=w+(w>=r?4:r-w),v=1),A||(l=c(_)),v)for(p=0;p<o.length;p++)o[p](y,d,E,m)};return u={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(m){return d/(1e3/(m||60))},wake:function(){qh&&(!ko&&_l()&&(An=ko=window,gl=An.document||{},ln.gsap=qt,(An.gsapVersions||(An.gsapVersions=[])).push(qt.version),Yh(Kr||An.GreenSockGlobals||!An.gsap&&An||{}),uu.forEach(du)),h=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&u.sleep(),c=h||function(m){return setTimeout(m,a-u.time*1e3+1|0)},Js=1,g(2))},sleep:function(){(h?cancelAnimationFrame:clearTimeout)(l),Js=0,c=Zs},lagSmoothing:function(m,f){e=m||1/0,t=Math.min(f||33,e)},fps:function(m){r=1e3/(m||240),a=u.time*1e3+r},add:function(m,f,A){var w=f?function(v,y,E,b){m(v,y,E,b),u.remove(w)}:m;return u.remove(m),o[A?"unshift":"push"](w),ws(),w},remove:function(m,f){~(f=o.indexOf(m))&&o.splice(f,1)&&p>=f&&p--},_listeners:o},u}(),ws=function(){return!Js&&tn.wake()},Be={},nv=/^[\d.\-M][\d.\-,\s]/,iv=/["']/g,sv=function(e){for(var t={},n=e.substr(1,e.length-3).split(":"),i=n[0],r=1,a=n.length,o,l,c;r<a;r++)l=n[r],o=r!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),t[i]=isNaN(c)?c.replace(iv,"").trim():+c,i=l.substr(o+1).trim();return t},rv=function(e){var t=e.indexOf("(")+1,n=e.indexOf(")"),i=e.indexOf("(",t);return e.substring(t,~i&&i<n?e.indexOf(")",n+1):n)},av=function(e){var t=(e+"").split("("),n=Be[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf("{")?[sv(t[1])]:rv(e).split(",").map(Jh)):Be._CE&&nv.test(e)?Be._CE("",e):n},_u=function(e){return function(t){return 1-e(1-t)}},gu=function s(e,t){for(var n=e._first,i;n;)n instanceof Nt?s(n,t):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==t&&(n.timeline?s(n.timeline,t):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=t)),n=n._next},Bi=function(e,t){return e&&(mt(e)?e:Be[e]||av(e))||t},Vi=function(e,t,n,i){n===void 0&&(n=function(l){return 1-t(1-l)}),i===void 0&&(i=function(l){return l<.5?t(l*2)/2:1-t((1-l)*2)/2});var r={easeIn:t,easeOut:n,easeInOut:i},a;return Ht(e,function(o){Be[o]=ln[o]=r,Be[a=o.toLowerCase()]=n;for(var l in r)Be[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Be[o+"."+l]=r[l]}),r},vu=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},qa=function s(e,t,n){var i=t>=1?t:1,r=(n||(e?.3:.45))/(t<1?t:1),a=r/Bo*(Math.asin(1/i)||0),o=function(h){return h===1?1:i*Math.pow(2,-10*h)*L0((h-a)*r)+1},l=e==="out"?o:e==="in"?function(c){return 1-o(1-c)}:vu(o);return r=Bo/r,l.config=function(c,h){return s(e,c,h)},l},Ya=function s(e,t){t===void 0&&(t=1.70158);var n=function(a){return a?--a*a*((t+1)*a+t)+1:0},i=e==="out"?n:e==="in"?function(r){return 1-n(1-r)}:vu(n);return i.config=function(r){return s(e,r)},i};Ht("Linear,Quad,Cubic,Quart,Quint,Strong",function(s,e){var t=e<5?e+1:e;Vi(s+",Power"+(t-1),e?function(n){return Math.pow(n,t)}:function(n){return n},function(n){return 1-Math.pow(1-n,t)},function(n){return n<.5?Math.pow(n*2,t)/2:1-Math.pow((1-n)*2,t)/2})});Be.Linear.easeNone=Be.none=Be.Linear.easeIn;Vi("Elastic",qa("in"),qa("out"),qa());(function(s,e){var t=1/e,n=2*t,i=2.5*t,r=function(o){return o<t?s*o*o:o<n?s*Math.pow(o-1.5/e,2)+.75:o<i?s*(o-=2.25/e)*o+.9375:s*Math.pow(o-2.625/e,2)+.984375};Vi("Bounce",function(a){return 1-r(1-a)},r)})(7.5625,2.75);Vi("Expo",function(s){return Math.pow(2,10*(s-1))*s+s*s*s*s*s*s*(1-s)});Vi("Circ",function(s){return-(Hh(1-s*s)-1)});Vi("Sine",function(s){return s===1?1:-P0(s*C0)+1});Vi("Back",Ya("in"),Ya("out"),Ya());Be.SteppedEase=Be.steps=ln.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,i=e+(t?0:1),r=t?1:0,a=1-et;return function(o){return((i*lr(0,a,o)|0)+r)*n}}};ys.ease=Be["quad.out"];Ht("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(s){return Ml+=s+","+s+"Params,"});var xu=function(e,t){this.id=R0++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:Zh,this.set=t?t.getSetter:wl},Qs=function(){function s(t){this.vars=t,this._delay=+t.delay||0,(this._repeat=t.repeat===1/0?-2:t.repeat||0)&&(this._rDelay=t.repeatDelay||0,this._yoyo=!!t.yoyo||!!t.yoyoEase),this._ts=1,bs(this,+t.duration,1,1),this.data=t.data,rt&&(this._ctx=rt,rt.data.push(this)),Js||tn.wake()}var e=s.prototype;return e.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},e.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},e.totalDuration=function(n){return arguments.length?(this._dirty=0,bs(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},e.totalTime=function(n,i){if(ws(),!arguments.length)return this._tTime;var r=this._dp;if(r&&r.smoothChildTiming&&this._ts){for(oa(this,n),!r._dp||r.parent||tu(r,this);r&&r.parent;)r.parent._time!==r._start+(r._ts>=0?r._tTime/r._ts:(r.totalDuration()-r._tTime)/-r._ts)&&r.totalTime(r._tTime,!0),r=r.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&Rn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===et||!this._initted&&this._dur&&n||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),$h(this,n,i)),this},e.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Vc(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},e.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},e.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Vc(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},e.iteration=function(n,i){var r=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*r,i):this._repeat?Ts(this._tTime,r)+1:1},e.timeScale=function(n,i){if(!arguments.length)return this._rts===-et?0:this._rts;if(this._rts===n)return this;var r=this.parent&&this._ts?Jr(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-et?0:this._rts,this.totalTime(lr(-Math.abs(this._delay),this.totalDuration(),r),i!==!1),aa(this),G0(this)},e.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(ws(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==et&&(this._tTime-=et)))),this):this._ps},e.startTime=function(n){if(arguments.length){this._start=ht(n);var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&Rn(i,this,this._start-this._delay),this}return this._start},e.endTime=function(n){return this._start+(Gt(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},e.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Jr(i.rawTime(n),this):this._tTime:this._tTime},e.revert=function(n){n===void 0&&(n=F0);var i=wt;return wt=n,yl(this)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),wt=i,this},e.globalTime=function(n){for(var i=this,r=arguments.length?n:i.rawTime();i;)r=i._start+r/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):r},e.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Wc(this)):this._repeat===-2?1/0:this._repeat},e.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,Wc(this),i?this.time(i):this}return this._rDelay},e.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},e.seek=function(n,i){return this.totalTime(fn(this,n),Gt(i))},e.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,Gt(i)),this._dur||(this._zTime=-et),this},e.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},e.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},e.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},e.resume=function(){return this.paused(!1)},e.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-et:0)),this):this._rts<0},e.invalidate=function(){return this._initted=this._act=0,this._zTime=-et,this},e.isActive=function(){var n=this.parent||this._dp,i=this._start,r;return!!(!n||this._ts&&this._initted&&n.isActive()&&(r=n.rawTime(!0))>=i&&r<this.endTime(!0)-et)},e.eventCallback=function(n,i,r){var a=this.vars;return arguments.length>1?(i?(a[n]=i,r&&(a[n+"Params"]=r),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},e.then=function(n){var i=this,r=i._prom;return new Promise(function(a){var o=mt(n)?n:Qh,l=function(){var h=i.then;i.then=null,r&&r(),mt(o)&&(o=o(i))&&(o.then||o===i)&&(i.then=h),a(o),i.then=h};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?l():i._prom=l})},e.kill=function(){Bs(this)},s}();cn(Qs.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-et,_prom:0,_ps:!1,_rts:1});var Nt=function(s){Gh(e,s);function e(n,i){var r;return n===void 0&&(n={}),r=s.call(this,n)||this,r.labels={},r.smoothChildTiming=!!n.smoothChildTiming,r.autoRemoveChildren=!!n.autoRemoveChildren,r._sort=Gt(n.sortChildren),ut&&Rn(n.parent||ut,Hn(r),i),n.reversed&&r.reverse(),n.paused&&r.paused(!0),n.scrollTrigger&&nu(Hn(r),n.scrollTrigger),r}var t=e.prototype;return t.to=function(i,r,a){return Vs(0,arguments,this),this},t.from=function(i,r,a){return Vs(1,arguments,this),this},t.fromTo=function(i,r,a,o){return Vs(2,arguments,this),this},t.set=function(i,r,a){return r.duration=0,r.parent=this,Hs(r).repeatDelay||(r.repeat=0),r.immediateRender=!!r.immediateRender,new xt(i,r,fn(this,a),1),this},t.call=function(i,r,a){return Rn(this,xt.delayedCall(0,i,r),a)},t.staggerTo=function(i,r,a,o,l,c,h){return a.duration=r,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=h,a.parent=this,new xt(i,a,fn(this,l)),this},t.staggerFrom=function(i,r,a,o,l,c,h){return a.runBackwards=1,Hs(a).immediateRender=Gt(a.immediateRender),this.staggerTo(i,r,a,o,l,c,h)},t.staggerFromTo=function(i,r,a,o,l,c,h,u){return o.startAt=a,Hs(o).immediateRender=Gt(o.immediateRender),this.staggerTo(i,r,o,l,c,h,u)},t.render=function(i,r,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,h=i<=0?0:ht(i),u=this._zTime<0!=i<0&&(this._initted||!c),d,p,g,_,m,f,A,w,v,y,E,b;if(this!==ut&&h>l&&i>=0&&(h=l),h!==this._tTime||a||u){if(o!==this._time&&c&&(h+=this._time-o,i+=this._time-o),d=h,v=this._start,w=this._ts,f=!w,u&&(c||(o=this._zTime),(i||!r)&&(this._zTime=i)),this._repeat){if(E=this._yoyo,m=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(m*100+i,r,a);if(d=ht(h%m),h===l?(_=this._repeat,d=c):(y=ht(h/m),_=~~y,_&&_===y&&(d=c,_--),d>c&&(d=c)),y=Ts(this._tTime,m),!o&&this._tTime&&y!==_&&this._tTime-y*m-this._dur<=0&&(y=_),E&&_&1&&(d=c-d,b=1),_!==y&&!this._lock){var R=E&&y&1,x=R===(E&&_&1);if(_<y&&(R=!R),o=R?0:h%c?c:h,this._lock=1,this.render(o||(b?0:ht(_*m)),r,!c)._lock=0,this._tTime=h,!r&&this.parent&&sn(this,"onRepeat"),this.vars.repeatRefresh&&!b&&(this.invalidate()._lock=1,y=_),o&&o!==this._time||f!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,x&&(this._lock=2,o=R?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!b&&this.invalidate()),this._lock=0,!this._ts&&!f)return this;gu(this,b)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(A=X0(this,ht(o),ht(d)),A&&(h-=d-(d=A._start))),this._tTime=h,this._time=d,this._act=!w,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&h&&c&&!r&&!y&&(sn(this,"onStart"),this._tTime!==h))return this;if(d>=o&&i>=0)for(p=this._first;p;){if(g=p._next,(p._act||d>=p._start)&&p._ts&&A!==p){if(p.parent!==this)return this.render(i,r,a);if(p.render(p._ts>0?(d-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(d-p._start)*p._ts,r,a),d!==this._time||!this._ts&&!f){A=0,g&&(h+=this._zTime=-et);break}}p=g}else{p=this._last;for(var M=i<0?i:d;p;){if(g=p._prev,(p._act||M<=p._end)&&p._ts&&A!==p){if(p.parent!==this)return this.render(i,r,a);if(p.render(p._ts>0?(M-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(M-p._start)*p._ts,r,a||wt&&yl(p)),d!==this._time||!this._ts&&!f){A=0,g&&(h+=this._zTime=M?-et:et);break}}p=g}}if(A&&!r&&(this.pause(),A.render(d>=o?0:-et)._zTime=d>=o?1:-1,this._ts))return this._start=v,aa(this),this.render(i,r,a);this._onUpdate&&!r&&sn(this,"onUpdate",!0),(h===l&&this._tTime>=this.totalDuration()||!h&&o)&&(v===this._start||Math.abs(w)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(h===l&&this._ts>0||!h&&this._ts<0)&&gi(this,1),!r&&!(i<0&&!o)&&(h||o||!l)&&(sn(this,h===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom())))}return this},t.add=function(i,r){var a=this;if(jn(r)||(r=fn(this,r,i)),!(i instanceof Qs)){if(Lt(i))return i.forEach(function(o){return a.add(o,r)}),this;if(bt(i))return this.addLabel(i,r);if(mt(i))i=xt.delayedCall(0,i);else return this}return this!==i?Rn(this,i,r):this},t.getChildren=function(i,r,a,o){i===void 0&&(i=!0),r===void 0&&(r=!0),a===void 0&&(a=!0),o===void 0&&(o=-_n);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof xt?r&&l.push(c):(a&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,r,a)))),c=c._next;return l},t.getById=function(i){for(var r=this.getChildren(1,1,1),a=r.length;a--;)if(r[a].vars.id===i)return r[a]},t.remove=function(i){return bt(i)?this.removeLabel(i):mt(i)?this.killTweensOf(i):(i.parent===this&&ra(this,i),i===this._recent&&(this._recent=this._last),zi(this))},t.totalTime=function(i,r){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=ht(tn.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),s.prototype.totalTime.call(this,i,r),this._forcing=0,this):this._tTime},t.addLabel=function(i,r){return this.labels[i]=fn(this,r),this},t.removeLabel=function(i){return delete this.labels[i],this},t.addPause=function(i,r,a){var o=xt.delayedCall(0,r||Zs,a);return o.data="isPause",this._hasPause=1,Rn(this,o,fn(this,i))},t.removePause=function(i){var r=this._first;for(i=fn(this,i);r;)r._start===i&&r.data==="isPause"&&gi(r),r=r._next},t.killTweensOf=function(i,r,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)oi!==o[l]&&o[l].kill(i,r);return this},t.getTweensOf=function(i,r){for(var a=[],o=gn(i),l=this._first,c=jn(r),h;l;)l instanceof xt?z0(l._targets,o)&&(c?(!oi||l._initted&&l._ts)&&l.globalTime(0)<=r&&l.globalTime(l.totalDuration())>r:!r||l.isActive())&&a.push(l):(h=l.getTweensOf(o,r)).length&&a.push.apply(a,h),l=l._next;return a},t.tweenTo=function(i,r){r=r||{};var a=this,o=fn(a,i),l=r,c=l.startAt,h=l.onStart,u=l.onStartParams,d=l.immediateRender,p,g=xt.to(a,cn({ease:r.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:r.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||et,onStart:function(){if(a.pause(),!p){var m=r.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale());g._dur!==m&&bs(g,m,0,1).render(g._time,!0,!0),p=1}h&&h.apply(g,u||[])}},r));return d?g.render(0):g},t.tweenFromTo=function(i,r,a){return this.tweenTo(r,cn({startAt:{time:fn(this,i)}},a))},t.recent=function(){return this._recent},t.nextLabel=function(i){return i===void 0&&(i=this._time),Xc(this,fn(this,i))},t.previousLabel=function(i){return i===void 0&&(i=this._time),Xc(this,fn(this,i),1)},t.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+et)},t.shiftChildren=function(i,r,a){a===void 0&&(a=0);var o=this._first,l=this.labels,c;for(i=ht(i);o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(r)for(c in l)l[c]>=a&&(l[c]+=i);return zi(this)},t.invalidate=function(i){var r=this._first;for(this._lock=0;r;)r.invalidate(i),r=r._next;return s.prototype.invalidate.call(this,i)},t.clear=function(i){i===void 0&&(i=!0);for(var r=this._first,a;r;)a=r._next,this.remove(r),r=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),zi(this)},t.totalDuration=function(i){var r=0,a=this,o=a._last,l=_n,c,h,u;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(u=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),h=o._start,h>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,Rn(a,o,h-o._delay,1)._lock=0):l=h,h<0&&o._ts&&(r-=h,(!u&&!a._dp||u&&u.smoothChildTiming)&&(a._start+=ht(h/a._ts),a._time-=h,a._tTime-=h),a.shiftChildren(-h,!1,-1/0),l=0),o._end>r&&o._ts&&(r=o._end),o=c;bs(a,a===ut&&a._time>r?a._time:r,1,1),a._dirty=0}return a._tDur},e.updateRoot=function(i){if(ut._ts&&($h(ut,Jr(i,ut)),Kh=tn.frame),tn.frame>=Gc){Gc+=on.autoSleep||120;var r=ut._first;if((!r||!r._ts)&&on.autoSleep&&tn._listeners.length<2){for(;r&&!r._ts;)r=r._next;r||tn.sleep()}}},e}(Qs);cn(Nt.prototype,{_lock:0,_hasPause:0,_forcing:0});var ov=function(e,t,n,i,r,a,o){var l=new Vt(this._pt,e,t,0,1,bu,null,r),c=0,h=0,u,d,p,g,_,m,f,A;for(l.b=n,l.e=i,n+="",i+="",(f=~i.indexOf("random("))&&(i=$s(i)),a&&(A=[n,i],a(A,e,t),n=A[0],i=A[1]),d=n.match(Va)||[];u=Va.exec(i);)g=u[0],_=i.substring(c,u.index),p?p=(p+1)%5:_.substr(-5)==="rgba("&&(p=1),g!==d[h++]&&(m=parseFloat(d[h-1])||0,l._pt={_next:l._pt,p:_||h===1?_:",",s:m,c:g.charAt(1)==="="?ps(m,g)-m:parseFloat(g)-m,m:p&&p<4?Math.round:0},c=Va.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=o,(Xh.test(i)||f)&&(l.e=0),this._pt=l,l},El=function(e,t,n,i,r,a,o,l,c,h){mt(i)&&(i=i(r||0,e,a));var u=e[t],d=n!=="get"?n:mt(u)?c?e[t.indexOf("set")||!mt(e["get"+t.substr(3)])?t:"get"+t.substr(3)](c):e[t]():u,p=mt(u)?c?dv:Eu:bl,g;if(bt(i)&&(~i.indexOf("random(")&&(i=$s(i)),i.charAt(1)==="="&&(g=ps(d,i)+(Rt(d)||0),(g||g===0)&&(i=g))),!h||d!==i||Yo)return!isNaN(d*i)&&i!==""?(g=new Vt(this._pt,e,t,+d||0,i-(d||0),typeof u=="boolean"?pv:Tu,0,p),c&&(g.fp=c),o&&g.modifier(o,this,e),this._pt=g):(!u&&!(t in e)&&vl(t,i),ov.call(this,e,t,d,i,p,l||on.stringFilter,c))},lv=function(e,t,n,i,r){if(mt(e)&&(e=Ws(e,r,t,n,i)),!Un(e)||e.style&&e.nodeType||Lt(e)||Vh(e))return bt(e)?Ws(e,r,t,n,i):e;var a={},o;for(o in e)a[o]=Ws(e[o],r,t,n,i);return a},Mu=function(e,t,n,i,r,a){var o,l,c,h;if(Jt[e]&&(o=new Jt[e]).init(r,o.rawVars?t[e]:lv(t[e],i,r,a,n),n,i,a)!==!1&&(n._pt=l=new Vt(n._pt,r,e,0,1,o.render,o,0,o.priority),n!==cs))for(c=n._ptLookup[n._targets.indexOf(r)],h=o._props.length;h--;)c[o._props[h]]=l;return o},oi,Yo,Tl=function s(e,t,n){var i=e.vars,r=i.ease,a=i.startAt,o=i.immediateRender,l=i.lazy,c=i.onUpdate,h=i.runBackwards,u=i.yoyoEase,d=i.keyframes,p=i.autoRevert,g=e._dur,_=e._startAt,m=e._targets,f=e.parent,A=f&&f.data==="nested"?f.vars.targets:m,w=e._overwrite==="auto"&&!pl,v=e.timeline,y,E,b,R,x,M,L,z,O,V,q,H,Y;if(v&&(!d||!r)&&(r="none"),e._ease=Bi(r,ys.ease),e._yEase=u?_u(Bi(u===!0?r:u,ys.ease)):0,u&&e._yoyo&&!e._repeat&&(u=e._yEase,e._yEase=e._ease,e._ease=u),e._from=!v&&!!i.runBackwards,!v||d&&!i.stagger){if(z=m[0]?Fi(m[0]).harness:0,H=z&&i[z.prop],y=$r(i,xl),_&&(_._zTime<0&&_.progress(1),t<0&&h&&o&&!p?_.render(-1,!0):_.revert(h&&g?Vr:O0),_._lazy=0),a){if(gi(e._startAt=xt.set(m,cn({data:"isStart",overwrite:!1,parent:f,immediateRender:!0,lazy:!_&&Gt(l),startAt:null,delay:0,onUpdate:c&&function(){return sn(e,"onUpdate")},stagger:0},a))),e._startAt._dp=0,e._startAt._sat=e,t<0&&(wt||!o&&!p)&&e._startAt.revert(Vr),o&&g&&t<=0&&n<=0){t&&(e._zTime=t);return}}else if(h&&g&&!_){if(t&&(o=!1),b=cn({overwrite:!1,data:"isFromStart",lazy:o&&!_&&Gt(l),immediateRender:o,stagger:0,parent:f},y),H&&(b[z.prop]=H),gi(e._startAt=xt.set(m,b)),e._startAt._dp=0,e._startAt._sat=e,t<0&&(wt?e._startAt.revert(Vr):e._startAt.render(-1,!0)),e._zTime=t,!o)s(e._startAt,et,et);else if(!t)return}for(e._pt=e._ptCache=0,l=g&&Gt(l)||l&&!g,E=0;E<m.length;E++){if(x=m[E],L=x._gsap||Sl(m)[E]._gsap,e._ptLookup[E]=V={},Go[L.id]&&ui.length&&Zr(),q=A===m?E:A.indexOf(x),z&&(O=new z).init(x,H||y,e,q,A)!==!1&&(e._pt=R=new Vt(e._pt,x,O.name,0,1,O.render,O,0,O.priority),O._props.forEach(function(G){V[G]=R}),O.priority&&(M=1)),!z||H)for(b in y)Jt[b]&&(O=Mu(b,y,e,q,x,A))?O.priority&&(M=1):V[b]=R=El.call(e,x,b,"get",y[b],q,A,0,i.stringFilter);e._op&&e._op[E]&&e.kill(x,e._op[E]),w&&e._pt&&(oi=e,ut.killTweensOf(x,V,e.globalTime(t)),Y=!e.parent,oi=0),e._pt&&l&&(Go[L.id]=1)}M&&wu(e),e._onInit&&e._onInit(e)}e._onUpdate=c,e._initted=(!e._op||e._pt)&&!Y,d&&t<=0&&v.render(_n,!0,!0)},cv=function(e,t,n,i,r,a,o,l){var c=(e._pt&&e._ptCache||(e._ptCache={}))[t],h,u,d,p;if(!c)for(c=e._ptCache[t]=[],d=e._ptLookup,p=e._targets.length;p--;){if(h=d[p][t],h&&h.d&&h.d._pt)for(h=h.d._pt;h&&h.p!==t&&h.fp!==t;)h=h._next;if(!h)return Yo=1,e.vars[t]="+=0",Tl(e,o),Yo=0,l?Ks(t+" not eligible for reset"):1;c.push(h)}for(p=c.length;p--;)u=c[p],h=u._pt||u,h.s=(i||i===0)&&!r?i:h.s+(i||0)+a*h.c,h.c=n-h.s,u.e&&(u.e=gt(n)+Rt(u.e)),u.b&&(u.b=h.s+Rt(u.b))},hv=function(e,t){var n=e[0]?Fi(e[0]).harness:0,i=n&&n.aliases,r,a,o,l;if(!i)return t;r=Es({},t);for(a in i)if(a in r)for(l=i[a].split(","),o=l.length;o--;)r[l[o]]=r[a];return r},uv=function(e,t,n,i){var r=t.ease||i||"power1.inOut",a,o;if(Lt(t))o=n[e]||(n[e]=[]),t.forEach(function(l,c){return o.push({t:c/(t.length-1)*100,v:l,e:r})});else for(a in t)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(e),v:t[a],e:r})},Ws=function(e,t,n,i,r){return mt(e)?e.call(t,n,i,r):bt(e)&&~e.indexOf("random(")?$s(e):e},Su=Ml+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",yu={};Ht(Su+",id,stagger,delay,duration,paused,scrollTrigger",function(s){return yu[s]=1});var xt=function(s){Gh(e,s);function e(n,i,r,a){var o;typeof i=="number"&&(r.duration=i,i=r,r=null),o=s.call(this,a?i:Hs(i))||this;var l=o.vars,c=l.duration,h=l.delay,u=l.immediateRender,d=l.stagger,p=l.overwrite,g=l.keyframes,_=l.defaults,m=l.scrollTrigger,f=l.yoyoEase,A=i.parent||ut,w=(Lt(n)||Vh(n)?jn(n[0]):"length"in i)?[n]:gn(n),v,y,E,b,R,x,M,L;if(o._targets=w.length?Sl(w):Ks("GSAP target "+n+" not found. https://gsap.com",!on.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=p,g||d||Nr(c)||Nr(h)){if(i=o.vars,v=o.timeline=new Nt({data:"nested",defaults:_||{},targets:A&&A.data==="nested"?A.vars.targets:w}),v.kill(),v.parent=v._dp=Hn(o),v._start=0,d||Nr(c)||Nr(h)){if(b=w.length,M=d&&au(d),Un(d))for(R in d)~Su.indexOf(R)&&(L||(L={}),L[R]=d[R]);for(y=0;y<b;y++)E=$r(i,yu),E.stagger=0,f&&(E.yoyoEase=f),L&&Es(E,L),x=w[y],E.duration=+Ws(c,Hn(o),y,x,w),E.delay=(+Ws(h,Hn(o),y,x,w)||0)-o._delay,!d&&b===1&&E.delay&&(o._delay=h=E.delay,o._start+=h,E.delay=0),v.to(x,E,M?M(y,x,w):0),v._ease=Be.none;v.duration()?c=h=0:o.timeline=0}else if(g){Hs(cn(v.vars.defaults,{ease:"none"})),v._ease=Bi(g.ease||i.ease||"none");var z=0,O,V,q;if(Lt(g))g.forEach(function(H){return v.to(w,H,">")}),v.duration();else{E={};for(R in g)R==="ease"||R==="easeEach"||uv(R,g[R],E,g.easeEach);for(R in E)for(O=E[R].sort(function(H,Y){return H.t-Y.t}),z=0,y=0;y<O.length;y++)V=O[y],q={ease:V.e,duration:(V.t-(y?O[y-1].t:0))/100*c},q[R]=V.v,v.to(w,q,z),z+=q.duration;v.duration()<c&&v.to({},{duration:c-v.duration()})}}c||o.duration(c=v.duration())}else o.timeline=0;return p===!0&&!pl&&(oi=Hn(o),ut.killTweensOf(w),oi=0),Rn(A,Hn(o),r),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(u||!c&&!g&&o._start===ht(A._time)&&Gt(u)&&H0(Hn(o))&&A.data!=="nested")&&(o._tTime=-et,o.render(Math.max(0,-h)||0)),m&&nu(Hn(o),m),o}var t=e.prototype;return t.render=function(i,r,a){var o=this._time,l=this._tDur,c=this._dur,h=i<0,u=i>l-et&&!h?l:i<et?0:i,d,p,g,_,m,f,A,w,v;if(!c)W0(this,i,r,a);else if(u!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==h||this._lazy){if(d=u,w=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&h)return this.totalTime(_*100+i,r,a);if(d=ht(u%_),u===l?(g=this._repeat,d=c):(m=ht(u/_),g=~~m,g&&g===m?(d=c,g--):d>c&&(d=c)),f=this._yoyo&&g&1,f&&(v=this._yEase,d=c-d),m=Ts(this._tTime,_),d===o&&!a&&this._initted&&g===m)return this._tTime=u,this;g!==m&&(w&&this._yEase&&gu(w,f),this.vars.repeatRefresh&&!f&&!this._lock&&d!==_&&this._initted&&(this._lock=a=1,this.render(ht(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(iu(this,h?i:d,a,r,u))return this._tTime=0,this;if(o!==this._time&&!(a&&this.vars.repeatRefresh&&g!==m))return this;if(c!==this._dur)return this.render(i,r,a)}if(this._tTime=u,this._time=d,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=A=(v||this._ease)(d/c),this._from&&(this.ratio=A=1-A),!o&&u&&!r&&!m&&(sn(this,"onStart"),this._tTime!==u))return this;for(p=this._pt;p;)p.r(A,p.d),p=p._next;w&&w.render(i<0?i:w._dur*w._ease(d/this._dur),r,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!r&&(h&&Ho(this,i,r,a),sn(this,"onUpdate")),this._repeat&&g!==m&&this.vars.onRepeat&&!r&&this.parent&&sn(this,"onRepeat"),(u===this._tDur||!u)&&this._tTime===u&&(h&&!this._onUpdate&&Ho(this,i,!0,!0),(i||!c)&&(u===this._tDur&&this._ts>0||!u&&this._ts<0)&&gi(this,1),!r&&!(h&&!o)&&(u||o||f)&&(sn(this,u===l?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom()))}return this},t.targets=function(){return this._targets},t.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),s.prototype.invalidate.call(this,i)},t.resetTo=function(i,r,a,o,l){Js||tn.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),h;return this._initted||Tl(this,c),h=this._ease(c/this._dur),cv(this,i,r,a,o,h,c,l)?this.resetTo(i,r,a,o,1):(oa(this,0),this.parent||eu(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},t.kill=function(i,r){if(r===void 0&&(r="all"),!i&&(!r||r==="all"))return this._lazy=this._pt=0,this.parent?Bs(this):this.scrollTrigger&&this.scrollTrigger.kill(!!wt),this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,r,oi&&oi.vars.overwrite!==!0)._first||Bs(this),this.parent&&a!==this.timeline.totalDuration()&&bs(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?gn(i):o,c=this._ptLookup,h=this._pt,u,d,p,g,_,m,f;if((!r||r==="all")&&k0(o,l))return r==="all"&&(this._pt=0),Bs(this);for(u=this._op=this._op||[],r!=="all"&&(bt(r)&&(_={},Ht(r,function(A){return _[A]=1}),r=_),r=hv(o,r)),f=o.length;f--;)if(~l.indexOf(o[f])){d=c[f],r==="all"?(u[f]=r,g=d,p={}):(p=u[f]=u[f]||{},g=r);for(_ in g)m=d&&d[_],m&&((!("kill"in m.d)||m.d.kill(_)===!0)&&ra(this,m,"_pt"),delete d[_]),p!=="all"&&(p[_]=1)}return this._initted&&!this._pt&&h&&Bs(this),this},e.to=function(i,r){return new e(i,r,arguments[2])},e.from=function(i,r){return Vs(1,arguments)},e.delayedCall=function(i,r,a,o){return new e(r,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:r,onReverseComplete:r,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},e.fromTo=function(i,r,a){return Vs(2,arguments)},e.set=function(i,r){return r.duration=0,r.repeatDelay||(r.repeat=0),new e(i,r)},e.killTweensOf=function(i,r,a){return ut.killTweensOf(i,r,a)},e}(Qs);cn(xt.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Ht("staggerTo,staggerFrom,staggerFromTo",function(s){xt[s]=function(){var e=new Nt,t=Wo.call(arguments,0);return t.splice(s==="staggerFromTo"?5:4,0,0),e[s].apply(e,t)}});var bl=function(e,t,n){return e[t]=n},Eu=function(e,t,n){return e[t](n)},dv=function(e,t,n,i){return e[t](i.fp,n)},fv=function(e,t,n){return e.setAttribute(t,n)},wl=function(e,t){return mt(e[t])?Eu:ml(e[t])&&e.setAttribute?fv:bl},Tu=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},pv=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},bu=function(e,t){var n=t._pt,i="";if(!e&&t.b)i=t.b;else if(e===1&&t.e)i=t.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+i,n=n._next;i+=t.c}t.set(t.t,t.p,i,t)},Al=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},mv=function(e,t,n,i){for(var r=this._pt,a;r;)a=r._next,r.p===i&&r.modifier(e,t,n),r=a},_v=function(e){for(var t=this._pt,n,i;t;)i=t._next,t.p===e&&!t.op||t.op===e?ra(this,t,"_pt"):t.dep||(n=1),t=i;return!n},gv=function(e,t,n,i){i.mSet(e,t,i.m.call(i.tween,n,i.mt),i)},wu=function(e){for(var t=e._pt,n,i,r,a;t;){for(n=t._next,i=r;i&&i.pr>t.pr;)i=i._next;(t._prev=i?i._prev:a)?t._prev._next=t:r=t,(t._next=i)?i._prev=t:a=t,t=n}e._pt=r},Vt=function(){function s(t,n,i,r,a,o,l,c,h){this.t=n,this.s=r,this.c=a,this.p=i,this.r=o||Tu,this.d=l||this,this.set=c||bl,this.pr=h||0,this._next=t,t&&(t._prev=this)}var e=s.prototype;return e.modifier=function(n,i,r){this.mSet=this.mSet||this.set,this.set=gv,this.m=n,this.mt=r,this.tween=i},s}();Ht(Ml+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(s){return xl[s]=1});ln.TweenMax=ln.TweenLite=xt;ln.TimelineLite=ln.TimelineMax=Nt;ut=new Nt({sortChildren:!1,defaults:ys,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});on.stringFilter=mu;var ki=[],Xr={},vv=[],Yc=0,xv=0,ja=function(e){return(Xr[e]||vv).map(function(t){return t()})},jo=function(){var e=Date.now(),t=[];e-Yc>2&&(ja("matchMediaInit"),ki.forEach(function(n){var i=n.queries,r=n.conditions,a,o,l,c;for(o in i)a=An.matchMedia(i[o]).matches,a&&(l=1),a!==r[o]&&(r[o]=a,c=1);c&&(n.revert(),l&&t.push(n))}),ja("matchMediaRevert"),t.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),Yc=e,ja("matchMedia"))},Au=function(){function s(t,n){this.selector=n&&Xo(n),this.data=[],this._r=[],this.isReverted=!1,this.id=xv++,t&&this.add(t)}var e=s.prototype;return e.add=function(n,i,r){mt(n)&&(r=i,i=n,n=mt);var a=this,o=function(){var c=rt,h=a.selector,u;return c&&c!==a&&c.data.push(a),r&&(a.selector=Xo(r)),rt=a,u=i.apply(a,arguments),mt(u)&&a._r.push(u),rt=c,a.selector=h,a.isReverted=!1,u};return a.last=o,n===mt?o(a,function(l){return a.add(null,l)}):n?a[n]=o:o},e.ignore=function(n){var i=rt;rt=null,n(this),rt=i},e.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof s?n.push.apply(n,i.getTweens()):i instanceof xt&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},e.clear=function(){this._r.length=this.data.length=0},e.kill=function(n,i){var r=this;if(n?function(){for(var o=r.getTweens(),l=r.data.length,c;l--;)c=r.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(h){return o.splice(o.indexOf(h),1)}));for(o.map(function(h){return{g:h._dur||h._delay||h._sat&&!h._sat.vars.immediateRender?h.globalTime(0):-1/0,t:h}}).sort(function(h,u){return u.g-h.g||-1/0}).forEach(function(h){return h.t.revert(n)}),l=r.data.length;l--;)c=r.data[l],c instanceof Nt?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof xt)&&c.revert&&c.revert(n);r._r.forEach(function(h){return h(n,r)}),r.isReverted=!0}():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),i)for(var a=ki.length;a--;)ki[a].id===this.id&&ki.splice(a,1)},e.revert=function(n){this.kill(n||{})},s}(),Mv=function(){function s(t){this.contexts=[],this.scope=t,rt&&rt.data.push(this)}var e=s.prototype;return e.add=function(n,i,r){Un(n)||(n={matches:n});var a=new Au(0,r||this.scope),o=a.conditions={},l,c,h;rt&&!a.selector&&(a.selector=rt.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(c in n)c==="all"?h=1:(l=An.matchMedia(n[c]),l&&(ki.indexOf(a)<0&&ki.push(a),(o[c]=l.matches)&&(h=1),l.addListener?l.addListener(jo):l.addEventListener("change",jo)));return h&&i(a,function(u){return a.add(null,u)}),this},e.revert=function(n){this.kill(n||{})},e.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},s}(),Qr={registerPlugin:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];t.forEach(function(i){return du(i)})},timeline:function(e){return new Nt(e)},getTweensOf:function(e,t){return ut.getTweensOf(e,t)},getProperty:function(e,t,n,i){bt(e)&&(e=gn(e)[0]);var r=Fi(e||{}).get,a=n?Qh:Jh;return n==="native"&&(n=""),e&&(t?a((Jt[t]&&Jt[t].get||r)(e,t,n,i)):function(o,l,c){return a((Jt[o]&&Jt[o].get||r)(e,o,l,c))})},quickSetter:function(e,t,n){if(e=gn(e),e.length>1){var i=e.map(function(h){return qt.quickSetter(h,t,n)}),r=i.length;return function(h){for(var u=r;u--;)i[u](h)}}e=e[0]||{};var a=Jt[t],o=Fi(e),l=o.harness&&(o.harness.aliases||{})[t]||t,c=a?function(h){var u=new a;cs._pt=0,u.init(e,n?h+n:h,cs,0,[e]),u.render(1,u),cs._pt&&Al(1,cs)}:o.set(e,l);return a?c:function(h){return c(e,l,n?h+n:h,o,1)}},quickTo:function(e,t,n){var i,r=qt.to(e,cn((i={},i[t]="+=0.1",i.paused=!0,i.stagger=0,i),n||{})),a=function(l,c,h){return r.resetTo(t,l,c,h)};return a.tween=r,a},isTweening:function(e){return ut.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=Bi(e.ease,ys.ease)),Hc(ys,e||{})},config:function(e){return Hc(on,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,i=e.plugins,r=e.defaults,a=e.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!Jt[o]&&!ln[o]&&Ks(t+" effect requires "+o+" plugin.")}),Wa[t]=function(o,l,c){return n(gn(o),cn(l||{},r),c)},a&&(Nt.prototype[t]=function(o,l,c){return this.add(Wa[t](o,Un(l)?l:(c=l)&&{},this),c)})},registerEase:function(e,t){Be[e]=Bi(t)},parseEase:function(e,t){return arguments.length?Bi(e,t):Be},getById:function(e){return ut.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new Nt(e),i,r;for(n.smoothChildTiming=Gt(e.smoothChildTiming),ut.remove(n),n._dp=0,n._time=n._tTime=ut._time,i=ut._first;i;)r=i._next,(t||!(!i._dur&&i instanceof xt&&i.vars.onComplete===i._targets[0]))&&Rn(n,i,i._start-i._delay),i=r;return Rn(ut,n,0),n},context:function(e,t){return e?new Au(e,t):rt},matchMedia:function(e){return new Mv(e)},matchMediaRefresh:function(){return ki.forEach(function(e){var t=e.conditions,n,i;for(i in t)t[i]&&(t[i]=!1,n=1);n&&e.revert()})||jo()},addEventListener:function(e,t){var n=Xr[e]||(Xr[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=Xr[e],i=n&&n.indexOf(t);i>=0&&n.splice(i,1)},utils:{wrap:J0,wrapYoyo:Q0,distribute:au,random:lu,snap:ou,normalize:$0,getUnit:Rt,clamp:Y0,splitColor:fu,toArray:gn,selector:Xo,mapRange:hu,pipe:K0,unitize:Z0,interpolate:ev,shuffle:ru},install:Yh,effects:Wa,ticker:tn,updateRoot:Nt.updateRoot,plugins:Jt,globalTimeline:ut,core:{PropTween:Vt,globals:jh,Tween:xt,Timeline:Nt,Animation:Qs,getCache:Fi,_removeLinkedListItem:ra,reverting:function(){return wt},context:function(e){return e&&rt&&(rt.data.push(e),e._ctx=rt),rt},suppressOverwrites:function(e){return pl=e}}};Ht("to,from,fromTo,delayedCall,set,killTweensOf",function(s){return Qr[s]=xt[s]});tn.add(Nt.updateRoot);cs=Qr.to({},{duration:0});var Sv=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},yv=function(e,t){var n=e._targets,i,r,a;for(i in t)for(r=n.length;r--;)a=e._ptLookup[r][i],a&&(a=a.d)&&(a._pt&&(a=Sv(a,i)),a&&a.modifier&&a.modifier(t[i],e,n[r],i))},Ka=function(e,t){return{name:e,headless:1,rawVars:1,init:function(i,r,a){a._onInit=function(o){var l,c;if(bt(r)&&(l={},Ht(r,function(h){return l[h]=1}),r=l),t){l={};for(c in r)l[c]=t(r[c]);r=l}yv(o,r)}}}},qt=Qr.registerPlugin({name:"attr",init:function(e,t,n,i,r){var a,o,l;this.tween=n;for(a in t)l=e.getAttribute(a)||"",o=this.add(e,"setAttribute",(l||0)+"",t[a],i,r,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(e,t){for(var n=t._pt;n;)wt?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:"endArray",headless:1,init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},Ka("roundProps",qo),Ka("modifiers"),Ka("snap",ou))||Qr;xt.version=Nt.version=qt.version="3.14.2";qh=1;_l()&&ws();Be.Power0;Be.Power1;Be.Power2;Be.Power3;Be.Power4;Be.Linear;Be.Quad;Be.Cubic;Be.Quart;Be.Quint;Be.Strong;Be.Elastic;Be.Back;Be.SteppedEase;Be.Bounce;Be.Sine;Be.Expo;Be.Circ;/*!
 * CSSPlugin 3.14.2
 * https://gsap.com
 *
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var jc,li,ms,Cl,Oi,Kc,Rl,Ev=function(){return typeof window<"u"},Kn={},Di=180/Math.PI,_s=Math.PI/180,rs=Math.atan2,Zc=1e8,Pl=/([A-Z])/g,Tv=/(left|right|width|margin|padding|x)/i,bv=/[\s,\(]\S/,Ln={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Ko=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},wv=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Av=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Cv=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Rv=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},Cu=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},Ru=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},Pv=function(e,t,n){return e.style[t]=n},Lv=function(e,t,n){return e.style.setProperty(t,n)},Dv=function(e,t,n){return e._gsap[t]=n},Iv=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},Uv=function(e,t,n,i,r){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(r,a)},Nv=function(e,t,n,i,r){var a=e._gsap;a[t]=n,a.renderTransform(r,a)},dt="transform",Wt=dt+"Origin",Ov=function s(e,t){var n=this,i=this.target,r=i.style,a=i._gsap;if(e in Kn&&r){if(this.tfm=this.tfm||{},e!=="transform")e=Ln[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return n.tfm[o]=Vn(i,o)}):this.tfm[e]=a.x?a[e]:Vn(i,e),e===Wt&&(this.tfm.zOrigin=a.zOrigin);else return Ln.transform.split(",").forEach(function(o){return s.call(n,o,t)});if(this.props.indexOf(dt)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Wt,t,"")),e=dt}(r||t)&&this.props.push(e,t,r[e])},Pu=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},Fv=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,r,a;for(r=0;r<e.length;r+=3)e[r+1]?e[r+1]===2?t[e[r]](e[r+2]):t[e[r]]=e[r+2]:e[r+2]?n[e[r]]=e[r+2]:n.removeProperty(e[r].substr(0,2)==="--"?e[r]:e[r].replace(Pl,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),r=Rl(),(!r||!r.isStart)&&!n[dt]&&(Pu(n),i.zOrigin&&n[Wt]&&(n[Wt]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Lu=function(e,t){var n={target:e,props:[],revert:Fv,save:Ov};return e._gsap||qt.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(i){return n.save(i)}),n},Du,Zo=function(e,t){var n=li.createElementNS?li.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):li.createElement(e);return n&&n.style?n:li.createElement(e)},rn=function s(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(Pl,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&s(e,As(t)||t,1)||""},$c="O,Moz,ms,Ms,Webkit".split(","),As=function(e,t,n){var i=t||Oi,r=i.style,a=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!($c[a]+e in r););return a<0?null:(a===3?"ms":a>=0?$c[a]:"")+e},$o=function(){Ev()&&window.document&&(jc=window,li=jc.document,ms=li.documentElement,Oi=Zo("div")||{style:{}},Zo("div"),dt=As(dt),Wt=dt+"Origin",Oi.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Du=!!As("perspective"),Rl=qt.core.reverting,Cl=1)},Jc=function(e){var t=e.ownerSVGElement,n=Zo("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=e.cloneNode(!0),r;i.style.display="block",n.appendChild(i),ms.appendChild(n);try{r=i.getBBox()}catch{}return n.removeChild(i),ms.removeChild(n),r},Qc=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Iu=function(e){var t,n;try{t=e.getBBox()}catch{t=Jc(e),n=1}return t&&(t.width||t.height)||n||(t=Jc(e)),t&&!t.width&&!t.x&&!t.y?{x:+Qc(e,["x","cx","x1"])||0,y:+Qc(e,["y","cy","y1"])||0,width:0,height:0}:t},Uu=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Iu(e))},vi=function(e,t){if(t){var n=e.style,i;t in Kn&&t!==Wt&&(t=dt),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(Pl,"-$1").toLowerCase())):n.removeAttribute(t)}},ci=function(e,t,n,i,r,a){var o=new Vt(e._pt,t,n,0,1,a?Ru:Cu);return e._pt=o,o.b=i,o.e=r,e._props.push(n),o},eh={deg:1,rad:1,turn:1},zv={grid:1,flex:1},xi=function s(e,t,n,i){var r=parseFloat(n)||0,a=(n+"").trim().substr((r+"").length)||"px",o=Oi.style,l=Tv.test(t),c=e.tagName.toLowerCase()==="svg",h=(c?"client":"offset")+(l?"Width":"Height"),u=100,d=i==="px",p=i==="%",g,_,m,f;if(i===a||!r||eh[i]||eh[a])return r;if(a!=="px"&&!d&&(r=s(e,t,n,"px")),f=e.getCTM&&Uu(e),(p||a==="%")&&(Kn[t]||~t.indexOf("adius")))return g=f?e.getBBox()[l?"width":"height"]:e[h],gt(p?r/g*u:r/100*g);if(o[l?"width":"height"]=u+(d?a:i),_=i!=="rem"&&~t.indexOf("adius")||i==="em"&&e.appendChild&&!c?e:e.parentNode,f&&(_=(e.ownerSVGElement||{}).parentNode),(!_||_===li||!_.appendChild)&&(_=li.body),m=_._gsap,m&&p&&m.width&&l&&m.time===tn.time&&!m.uncache)return gt(r/m.width*u);if(p&&(t==="height"||t==="width")){var A=e.style[t];e.style[t]=u+i,g=e[h],A?e.style[t]=A:vi(e,t)}else(p||a==="%")&&!zv[rn(_,"display")]&&(o.position=rn(e,"position")),_===e&&(o.position="static"),_.appendChild(Oi),g=Oi[h],_.removeChild(Oi),o.position="absolute";return l&&p&&(m=Fi(_),m.time=tn.time,m.width=_[h]),gt(d?g*r/u:g&&r?u/g*r:0)},Vn=function(e,t,n,i){var r;return Cl||$o(),t in Ln&&t!=="transform"&&(t=Ln[t],~t.indexOf(",")&&(t=t.split(",")[0])),Kn[t]&&t!=="transform"?(r=tr(e,i),r=t!=="transformOrigin"?r[t]:r.svg?r.origin:ta(rn(e,Wt))+" "+r.zOrigin+"px"):(r=e.style[t],(!r||r==="auto"||i||~(r+"").indexOf("calc("))&&(r=ea[t]&&ea[t](e,t,n)||rn(e,t)||Zh(e,t)||(t==="opacity"?1:0))),n&&!~(r+"").trim().indexOf(" ")?xi(e,t,r,n)+n:r},Bv=function(e,t,n,i){if(!n||n==="none"){var r=As(t,e,1),a=r&&rn(e,r,1);a&&a!==n?(t=r,n=a):t==="borderColor"&&(n=rn(e,"borderTopColor"))}var o=new Vt(this._pt,e.style,t,0,1,bu),l=0,c=0,h,u,d,p,g,_,m,f,A,w,v,y;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=rn(e,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=e.style[t],e.style[t]=i,i=rn(e,t)||i,_?e.style[t]=_:vi(e,t)),h=[n,i],mu(h),n=h[0],i=h[1],d=n.match(ls)||[],y=i.match(ls)||[],y.length){for(;u=ls.exec(i);)m=u[0],A=i.substring(l,u.index),g?g=(g+1)%5:(A.substr(-5)==="rgba("||A.substr(-5)==="hsla(")&&(g=1),m!==(_=d[c++]||"")&&(p=parseFloat(_)||0,v=_.substr((p+"").length),m.charAt(1)==="="&&(m=ps(p,m)+v),f=parseFloat(m),w=m.substr((f+"").length),l=ls.lastIndex-w.length,w||(w=w||on.units[t]||v,l===i.length&&(i+=w,o.e+=w)),v!==w&&(p=xi(e,t,_,w)||0),o._pt={_next:o._pt,p:A||c===1?A:",",s:p,c:f-p,m:g&&g<4||t==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=t==="display"&&i==="none"?Ru:Cu;return Xh.test(i)&&(o.e=0),this._pt=o,o},th={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},kv=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=th[n]||n,t[1]=th[i]||i,t.join(" ")},Gv=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,r=t.u,a=n._gsap,o,l,c;if(r==="all"||r===!0)i.cssText="",l=1;else for(r=r.split(","),c=r.length;--c>-1;)o=r[c],Kn[o]&&(l=1,o=o==="transformOrigin"?Wt:dt),vi(n,o);l&&(vi(n,dt),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",tr(n,1),a.uncache=1,Pu(i)))}},ea={clearProps:function(e,t,n,i,r){if(r.data!=="isFromStart"){var a=e._pt=new Vt(e._pt,t,n,0,0,Gv);return a.u=i,a.pr=-10,a.tween=r,e._props.push(n),1}}},er=[1,0,0,1,0,0],Nu={},Ou=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},nh=function(e){var t=rn(e,dt);return Ou(t)?er:t.substr(7).match(Wh).map(gt)},Ll=function(e,t){var n=e._gsap||Fi(e),i=e.style,r=nh(e),a,o,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,r=[l.a,l.b,l.c,l.d,l.e,l.f],r.join(",")==="1,0,0,1,0,0"?er:r):(r===er&&!e.offsetParent&&e!==ms&&!n.svg&&(l=i.display,i.display="block",a=e.parentNode,(!a||!e.offsetParent&&!e.getBoundingClientRect().width)&&(c=1,o=e.nextElementSibling,ms.appendChild(e)),r=nh(e),l?i.display=l:vi(e,"display"),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):ms.removeChild(e))),t&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},Jo=function(e,t,n,i,r,a){var o=e._gsap,l=r||Ll(e,!0),c=o.xOrigin||0,h=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,p=l[0],g=l[1],_=l[2],m=l[3],f=l[4],A=l[5],w=t.split(" "),v=parseFloat(w[0])||0,y=parseFloat(w[1])||0,E,b,R,x;n?l!==er&&(b=p*m-g*_)&&(R=v*(m/b)+y*(-_/b)+(_*A-m*f)/b,x=v*(-g/b)+y*(p/b)-(p*A-g*f)/b,v=R,y=x):(E=Iu(e),v=E.x+(~w[0].indexOf("%")?v/100*E.width:v),y=E.y+(~(w[1]||w[0]).indexOf("%")?y/100*E.height:y)),i||i!==!1&&o.smooth?(f=v-c,A=y-h,o.xOffset=u+(f*p+A*_)-f,o.yOffset=d+(f*g+A*m)-A):o.xOffset=o.yOffset=0,o.xOrigin=v,o.yOrigin=y,o.smooth=!!i,o.origin=t,o.originIsAbsolute=!!n,e.style[Wt]="0px 0px",a&&(ci(a,o,"xOrigin",c,v),ci(a,o,"yOrigin",h,y),ci(a,o,"xOffset",u,o.xOffset),ci(a,o,"yOffset",d,o.yOffset)),e.setAttribute("data-svg-origin",v+" "+y)},tr=function(e,t){var n=e._gsap||new xu(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,r=n.scaleX<0,a="px",o="deg",l=getComputedStyle(e),c=rn(e,Wt)||"0",h,u,d,p,g,_,m,f,A,w,v,y,E,b,R,x,M,L,z,O,V,q,H,Y,G,ne,le,me,Pe,Ye,W,te;return h=u=d=_=m=f=A=w=v=0,p=g=1,n.svg=!!(e.getCTM&&Uu(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[dt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[dt]!=="none"?l[dt]:"")),i.scale=i.rotate=i.translate="none"),b=Ll(e,n.svg),n.svg&&(n.uncache?(G=e.getBBox(),c=n.xOrigin-G.x+"px "+(n.yOrigin-G.y)+"px",Y=""):Y=!t&&e.getAttribute("data-svg-origin"),Jo(e,Y||c,!!Y||n.originIsAbsolute,n.smooth!==!1,b)),y=n.xOrigin||0,E=n.yOrigin||0,b!==er&&(L=b[0],z=b[1],O=b[2],V=b[3],h=q=b[4],u=H=b[5],b.length===6?(p=Math.sqrt(L*L+z*z),g=Math.sqrt(V*V+O*O),_=L||z?rs(z,L)*Di:0,A=O||V?rs(O,V)*Di+_:0,A&&(g*=Math.abs(Math.cos(A*_s))),n.svg&&(h-=y-(y*L+E*O),u-=E-(y*z+E*V))):(te=b[6],Ye=b[7],le=b[8],me=b[9],Pe=b[10],W=b[11],h=b[12],u=b[13],d=b[14],R=rs(te,Pe),m=R*Di,R&&(x=Math.cos(-R),M=Math.sin(-R),Y=q*x+le*M,G=H*x+me*M,ne=te*x+Pe*M,le=q*-M+le*x,me=H*-M+me*x,Pe=te*-M+Pe*x,W=Ye*-M+W*x,q=Y,H=G,te=ne),R=rs(-O,Pe),f=R*Di,R&&(x=Math.cos(-R),M=Math.sin(-R),Y=L*x-le*M,G=z*x-me*M,ne=O*x-Pe*M,W=V*M+W*x,L=Y,z=G,O=ne),R=rs(z,L),_=R*Di,R&&(x=Math.cos(R),M=Math.sin(R),Y=L*x+z*M,G=q*x+H*M,z=z*x-L*M,H=H*x-q*M,L=Y,q=G),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,f=180-f),p=gt(Math.sqrt(L*L+z*z+O*O)),g=gt(Math.sqrt(H*H+te*te)),R=rs(q,H),A=Math.abs(R)>2e-4?R*Di:0,v=W?1/(W<0?-W:W):0),n.svg&&(Y=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Ou(rn(e,dt)),Y&&e.setAttribute("transform",Y))),Math.abs(A)>90&&Math.abs(A)<270&&(r?(p*=-1,A+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,A+=A<=0?180:-180)),t=t||n.uncache,n.x=h-((n.xPercent=h&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-h)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-u)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=gt(p),n.scaleY=gt(g),n.rotation=gt(_)+o,n.rotationX=gt(m)+o,n.rotationY=gt(f)+o,n.skewX=A+o,n.skewY=w+o,n.transformPerspective=v+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!t&&n.zOrigin||0)&&(i[Wt]=ta(c)),n.xOffset=n.yOffset=0,n.force3D=on.force3D,n.renderTransform=n.svg?Vv:Du?Fu:Hv,n.uncache=0,n},ta=function(e){return(e=e.split(" "))[0]+" "+e[1]},Za=function(e,t,n){var i=Rt(t);return gt(parseFloat(t)+parseFloat(xi(e,"x",n+"px",i)))+i},Hv=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Fu(e,t)},Ri="0deg",Os="0px",Pi=") ",Fu=function(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,h=n.rotationY,u=n.rotationX,d=n.skewX,p=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,f=n.force3D,A=n.target,w=n.zOrigin,v="",y=f==="auto"&&e&&e!==1||f===!0;if(w&&(u!==Ri||h!==Ri)){var E=parseFloat(h)*_s,b=Math.sin(E),R=Math.cos(E),x;E=parseFloat(u)*_s,x=Math.cos(E),a=Za(A,a,b*x*-w),o=Za(A,o,-Math.sin(E)*-w),l=Za(A,l,R*x*-w+w)}m!==Os&&(v+="perspective("+m+Pi),(i||r)&&(v+="translate("+i+"%, "+r+"%) "),(y||a!==Os||o!==Os||l!==Os)&&(v+=l!==Os||y?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+Pi),c!==Ri&&(v+="rotate("+c+Pi),h!==Ri&&(v+="rotateY("+h+Pi),u!==Ri&&(v+="rotateX("+u+Pi),(d!==Ri||p!==Ri)&&(v+="skew("+d+", "+p+Pi),(g!==1||_!==1)&&(v+="scale("+g+", "+_+Pi),A.style[dt]=v||"translate(0, 0)"},Vv=function(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,h=n.skewY,u=n.scaleX,d=n.scaleY,p=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,f=n.yOffset,A=n.forceCSS,w=parseFloat(a),v=parseFloat(o),y,E,b,R,x;l=parseFloat(l),c=parseFloat(c),h=parseFloat(h),h&&(h=parseFloat(h),c+=h,l+=h),l||c?(l*=_s,c*=_s,y=Math.cos(l)*u,E=Math.sin(l)*u,b=Math.sin(l-c)*-d,R=Math.cos(l-c)*d,c&&(h*=_s,x=Math.tan(c-h),x=Math.sqrt(1+x*x),b*=x,R*=x,h&&(x=Math.tan(h),x=Math.sqrt(1+x*x),y*=x,E*=x)),y=gt(y),E=gt(E),b=gt(b),R=gt(R)):(y=u,R=d,E=b=0),(w&&!~(a+"").indexOf("px")||v&&!~(o+"").indexOf("px"))&&(w=xi(p,"x",a,"px"),v=xi(p,"y",o,"px")),(g||_||m||f)&&(w=gt(w+g-(g*y+_*b)+m),v=gt(v+_-(g*E+_*R)+f)),(i||r)&&(x=p.getBBox(),w=gt(w+i/100*x.width),v=gt(v+r/100*x.height)),x="matrix("+y+","+E+","+b+","+R+","+w+","+v+")",p.setAttribute("transform",x),A&&(p.style[dt]=x)},Wv=function(e,t,n,i,r){var a=360,o=bt(r),l=parseFloat(r)*(o&&~r.indexOf("rad")?Di:1),c=l-i,h=i+c+"deg",u,d;return o&&(u=r.split("_")[1],u==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),u==="cw"&&c<0?c=(c+a*Zc)%a-~~(c/a)*a:u==="ccw"&&c>0&&(c=(c-a*Zc)%a-~~(c/a)*a)),e._pt=d=new Vt(e._pt,t,n,i,c,wv),d.e=h,d.u="deg",e._props.push(n),d},ih=function(e,t){for(var n in t)e[n]=t[n];return e},Xv=function(e,t,n){var i=ih({},n._gsap),r="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,h,u,d,p,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[dt]=t,o=tr(n,1),vi(n,dt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[dt],a[dt]=t,o=tr(n,1),a[dt]=c);for(l in Kn)c=i[l],h=o[l],c!==h&&r.indexOf(l)<0&&(p=Rt(c),g=Rt(h),u=p!==g?xi(n,l,c,g):parseFloat(c),d=parseFloat(h),e._pt=new Vt(e._pt,o,l,u,d-u,Ko),e._pt.u=g||0,e._props.push(l));ih(o,i)};Ht("padding,margin,Width,Radius",function(s,e){var t="Top",n="Right",i="Bottom",r="Left",a=(e<3?[t,n,i,r]:[t+r,t+n,i+n,i+r]).map(function(o){return e<2?s+o:"border"+o+s});ea[e>1?"border"+s:s]=function(o,l,c,h,u){var d,p;if(arguments.length<4)return d=a.map(function(g){return Vn(o,g,c)}),p=d.join(" "),p.split(d[0]).length===5?d[0]:p;d=(h+"").split(" "),p={},a.forEach(function(g,_){return p[g]=d[_]=d[_]||d[(_-1)/2|0]}),o.init(l,p,u)}});var zu={name:"css",register:$o,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,r){var a=this._props,o=e.style,l=n.vars.startAt,c,h,u,d,p,g,_,m,f,A,w,v,y,E,b,R,x;Cl||$o(),this.styles=this.styles||Lu(e),R=this.styles.props,this.tween=n;for(_ in t)if(_!=="autoRound"&&(h=t[_],!(Jt[_]&&Mu(_,t,n,i,e,r)))){if(p=typeof h,g=ea[_],p==="function"&&(h=h.call(n,i,e,r),p=typeof h),p==="string"&&~h.indexOf("random(")&&(h=$s(h)),g)g(this,e,_,h,n)&&(b=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(_)+"").trim(),h+="",di.lastIndex=0,di.test(c)||(m=Rt(c),f=Rt(h),f?m!==f&&(c=xi(e,_,c,f)+f):m&&(h+=m)),this.add(o,"setProperty",c,h,i,r,0,0,_),a.push(_),R.push(_,0,o[_]);else if(p!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,e,r):l[_],bt(c)&&~c.indexOf("random(")&&(c=$s(c)),Rt(c+"")||c==="auto"||(c+=on.units[_]||Rt(Vn(e,_))||""),(c+"").charAt(1)==="="&&(c=Vn(e,_))):c=Vn(e,_),d=parseFloat(c),A=p==="string"&&h.charAt(1)==="="&&h.substr(0,2),A&&(h=h.substr(2)),u=parseFloat(h),_ in Ln&&(_==="autoAlpha"&&(d===1&&Vn(e,"visibility")==="hidden"&&u&&(d=0),R.push("visibility",0,o.visibility),ci(this,o,"visibility",d?"inherit":"hidden",u?"inherit":"hidden",!u)),_!=="scale"&&_!=="transform"&&(_=Ln[_],~_.indexOf(",")&&(_=_.split(",")[0]))),w=_ in Kn,w){if(this.styles.save(_),x=h,p==="string"&&h.substring(0,6)==="var(--"){if(h=rn(e,h.substring(4,h.indexOf(")"))),h.substring(0,5)==="calc("){var M=e.style.perspective;e.style.perspective=h,h=rn(e,"perspective"),M?e.style.perspective=M:vi(e,"perspective")}u=parseFloat(h)}if(v||(y=e._gsap,y.renderTransform&&!t.parseTransform||tr(e,t.parseTransform),E=t.smoothOrigin!==!1&&y.smooth,v=this._pt=new Vt(this._pt,o,dt,0,1,y.renderTransform,y,0,-1),v.dep=1),_==="scale")this._pt=new Vt(this._pt,y,"scaleY",y.scaleY,(A?ps(y.scaleY,A+u):u)-y.scaleY||0,Ko),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){R.push(Wt,0,o[Wt]),h=kv(h),y.svg?Jo(e,h,0,E,0,this):(f=parseFloat(h.split(" ")[2])||0,f!==y.zOrigin&&ci(this,y,"zOrigin",y.zOrigin,f),ci(this,o,_,ta(c),ta(h)));continue}else if(_==="svgOrigin"){Jo(e,h,1,E,0,this);continue}else if(_ in Nu){Wv(this,y,_,d,A?ps(d,A+h):h);continue}else if(_==="smoothOrigin"){ci(this,y,"smooth",y.smooth,h);continue}else if(_==="force3D"){y[_]=h;continue}else if(_==="transform"){Xv(this,h,e);continue}}else _ in o||(_=As(_)||_);if(w||(u||u===0)&&(d||d===0)&&!bv.test(h)&&_ in o)m=(c+"").substr((d+"").length),u||(u=0),f=Rt(h)||(_ in on.units?on.units[_]:m),m!==f&&(d=xi(e,_,c,f)),this._pt=new Vt(this._pt,w?y:o,_,d,(A?ps(d,A+u):u)-d,!w&&(f==="px"||_==="zIndex")&&t.autoRound!==!1?Rv:Ko),this._pt.u=f||0,w&&x!==h?(this._pt.b=c,this._pt.e=x,this._pt.r=Cv):m!==f&&f!=="%"&&(this._pt.b=c,this._pt.r=Av);else if(_ in o)Bv.call(this,e,_,c,A?A+h:h);else if(_ in e)this.add(e,_,c||e[_],A?A+h:h,i,r);else if(_!=="parseTransform"){vl(_,h);continue}w||(_ in o?R.push(_,0,o[_]):typeof e[_]=="function"?R.push(_,2,e[_]()):R.push(_,1,c||e[_])),a.push(_)}}b&&wu(this)},render:function(e,t){if(t.tween._time||!Rl())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Vn,aliases:Ln,getSetter:function(e,t,n){var i=Ln[t];return i&&i.indexOf(",")<0&&(t=i),t in Kn&&t!==Wt&&(e._gsap.x||Vn(e,"x"))?n&&Kc===n?t==="scale"?Iv:Dv:(Kc=n||{})&&(t==="scale"?Uv:Nv):e.style&&!ml(e.style[t])?Pv:~t.indexOf("-")?Lv:wl(e,t)},core:{_removeProperty:vi,_getMatrix:Ll}};qt.utils.checkPrefix=As;qt.core.getStyleSaver=Lu;(function(s,e,t,n){var i=Ht(s+","+e+","+t,function(r){Kn[r]=1});Ht(e,function(r){on.units[r]="deg",Nu[r]=1}),Ln[i[13]]=s+","+e,Ht(n,function(r){var a=r.split(":");Ln[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Ht("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(s){on.units[s]="px"});qt.registerPlugin(zu);var ft=qt.registerPlugin(zu)||qt;ft.core.Tween;class qv{experience;scene;environment;background;globes;lerp={active:!1,currentX:0,targetX:0,currentY:0,targetY:0,ease:.04};constructor(){this.experience=new Xt,this.scene=this.experience.scene,this.environment=new x0,this.globes=new w0,this.background=new A0}resize(){}update(){this.environment.update(),this.globes.update(),this.globes.currentGroup.visible=!1,this.lerp.active&&(this.lerp.currentX=ft.utils.interpolate(this.lerp.currentX,this.lerp.targetX,this.lerp.ease),this.lerp.currentY=ft.utils.interpolate(this.lerp.currentY,this.lerp.targetY,this.lerp.ease),this.globes.currentGroup.position.y=this.lerp.currentX*.1,this.globes.currentGroup.position.x=this.lerp.currentY*.1),this.globes.currentGroup.visible=!0}}class Yv extends sa.EventEmitter{startTime;currentTime;elapsed;delta;constructor(){super(),this.startTime=Date.now(),this.currentTime=this.startTime,this.elapsed=0,this.delta=16,this.update()}update(){const e=Date.now();this.delta=e-this.currentTime,this.currentTime=e,this.elapsed=this.currentTime-this.startTime,this.emit("tick",this.delta),window.requestAnimationFrame(()=>this.update())}}const jv={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
            ...
            gl_FragColor = color;
		}`},ix={name:"VignetteShader",uniforms:{tDiffuse:{value:null},center:{value:new Ce(.5,.5)},intensity:{value:.8},radius:{value:.6},softness:{value:.05},darkness:{value:0},sharpness:{value:8},aspectRatio:{value:1}},vertexShader:`
		varying vec2 vUv;
